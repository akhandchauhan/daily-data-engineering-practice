...
-- Each row contains a product category and the percentage discount applied to that category 
...
-- ++----+
-- Explanation:
-- For product 1, it belongs to the Electronics category which has a 10% discount, so the final price is 
--1000 - (10% of 1000) = 900.
-- For product 2, it belongs to the Clothing category which has a 20% discount, so the final price is 
--50 - (20% of 50) = 40.
-- For product 3, it belongs to the Electronics category and receives a 10% discount, so the final price
-- is 1200 - (10% of 1200) = 1080.
...
SELECT product_id, p.category, price-(IFNULL(discount,0))*price/100 as final_price
FROM Products p
