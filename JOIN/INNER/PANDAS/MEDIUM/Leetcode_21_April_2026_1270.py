...
# Explanation: 
# The head of the company is the employee with employee_id 1.
# The employees with employee_id 2 and 77 report their work directly to the
#  head of the company.
# The employee with employee_id 4 reports their work indirectly to the head 
# of the company 4 --> 2 --> 1. 
# The employee with employee_id 7 reports their work indirectly to the head 
...
employees = pd.DataFrame({
    ...
    "employee_name": ["Boss", "Alice", "Bob", "Daniel", "Luis", 
                      "Jhon", "Angela", "Robert"],
    "manager_id": [1, 3, 1, 2, 4, 3, 8, 1]
})

df = (
    employees.merge(employees, left_on ='manager_id',right_on ='employee_id')
    .merge(employees,left_on ='manager_id_y',right_on ='employee_id')
    .loc[lambda d: (d['employee_id_x'] != 1) & (d['manager_id'] == 1)]
    [['employee_id_x']]
