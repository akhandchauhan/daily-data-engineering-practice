...
-- Write a solution to calculate the points, position, and tier for each team in the league. 
...
-- Tier 1: The top 33% of teams based on points. Sheffield United, Fulham, Newcastle United, and 
--Chelsea fall into Tier 1.
...
INSERT INTO TeamStats (team_id, team_name, matches_played, wins, draws, losses) VALUES
('1', 'Chelsea', '22', '13', '2', '7'),
('2', 'Nottingham Forest', '27', '6', '6', '15'),
('3', 'Liverpool', '17', '1', '8', '8'),
('4', 'Aston Villa', '20', '1', '6', '13'),
...
RankedTeams AS (
    SELECT
        ...
        PERCENT_RANK() OVER (ORDER BY points DESC, team_name ASC) AS percent_rank
    FROM PointsTable
)
SELECT
        team_name,
