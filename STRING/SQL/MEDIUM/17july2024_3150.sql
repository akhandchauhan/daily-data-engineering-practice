...
insert into Tweets (tweet_id, content) values ('3', 'Never been happier about todays achievements @SaraJohnson @JohnDoe @AnnaWilson #Fashion');
...
insert into Tweets (tweet_id, content) values ('6', 'Never been happier about todays achievements @ChrisAnderson #Fashion #WorkLife');
insert into Tweets (tweet_id, content) values ('7', 'So grateful for todays experiences @AnnaWilson @LisaTaylor @ChrisAnderson @MikeBrown #Fashion #HappyDay #WorkLife #Nature');
...
insert into Tweets (tweet_id, content) values ('10', 'So grateful for todays experiences @ChrisAnderson #Nature');
insert into Tweets (tweet_id, content) values ('11', 'So grateful for todays experiences @AlexJones #Art #WorkLife');
