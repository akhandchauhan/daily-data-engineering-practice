...
# - Values in the fourth row cannot form a triangle, because the combined value 
...
triangle_classify['triangle_type'] = np.select(conditions, values, default = 'Isosceles')
triangle_classify = triangle_classify[['triangle_type']]
print(triangle_classify)