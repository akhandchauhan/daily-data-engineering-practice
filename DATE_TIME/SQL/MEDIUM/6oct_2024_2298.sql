...
INSERT INTO Tasks (task_id, assignee_id, submit_date)
VALUES
(1, 1, '2022-06-13'),
(2, 6, '2022-06-14'),
(3, 6, '2022-06-15'),
...
WITH cte as (
    SELECT DAYOFWEEK(submit_date) as dayname
    FROM Tasks
)
SELECT SUM(CASE WHEN dayname IN (1,7) THEN 1 ELSE 0 END) AS weekend_cnt,
       SUM(CASE WHEN dayname NOT IN (1,7) THEN 1 ELSE 0 END) AS working_cnt
FROM cte;
