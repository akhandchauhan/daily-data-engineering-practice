...
bin1 = sessions_df[sessions_df['duration']/60 < 5 ].rename(columns = {'duration':"total"})['total'].count()
bin2 = sessions_df[(sessions_df['duration']/60 >= 5) & (sessions_df['duration']/60 < 10) ].rename(columns = {'duration':"total"})['total'].count()
bin3 = sessions_df[(sessions_df['duration']/60 >= 10) & (sessions_df['duration']/60 < 15) ].rename(columns = {'duration':"total"})['total'].count()
bin4 = sessions_df[sessions_df['duration']/60 >= 15].rename(columns = {'duration':"total"})['total'].count()
